...
let obj_list =[
	...
	"./obj/beach/beach.obj",
	"./obj/telo_mare.obj",
	"./obj/beach_umbrella/beach_umbrella.obj"
]
...
async function main() {
    ...
    obj_list.forEach(async function(obj_file) {
        let m = [];
        m.sourceMesh = obj_file;
        LoadMesh(gl,m).then(function() {
            mesh_list.push(m);
        });
    } );
